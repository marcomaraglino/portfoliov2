...
const Layout = () => {
    return (
        ...
        <div className="flex flex-col container max-sm:w-72 mx-auto w-screen h-full">
            <div className="flex flex-col absolute container max-sm:w-72 top-10 pb-10 py-4">
            <div className="flex justify-between">
                <Link to="/" className="font-normal text-base mb-4">marco maraglino</Link>
                <h1 className="opacity-50 text-base">sw engineer</h1>
            </div>
            <hr className="w-full h-1/6 bg-gray-100/50 mb-4 border-indigo-50/30 rounded dark:bg-gray-500/50"/>
